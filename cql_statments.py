...
create_artist = """CREATE TABLE IF NOT EXISTS artist_library
                (userId float , sessionId int,artist text, song text, itemInSession int, firstName text, lastName text, 
...
select_artist = "SELECT * FROM artist_library WHERE userid = 10 and sessionid = 182 "
